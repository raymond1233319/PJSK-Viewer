                    ...
                    DetailBuilder.buildCard(
                      children: [
                        ...
                        DetailBuilder.buildCardThumbnailList(
                          context,
                          localizations
                                  ?.translate('gacha', "pickupMember_plural")
                                  .translated ??
                              "Pick-up Members",
                          pickupCards,
                        ),
                                  ...
                                  builder:
                                      (_) => CardIndexPage(
                                        ...
                                        buildTextOverlay: (card) {
                                          ...
                                          final total = rarityTotals[r] ?? 0;
                                          final pct =
                                              w / total * (ratesMap[r] ?? 0);
